...
public class FaceDetection extends javax.swing.JFrame {
    ...
    //CascadeClassifier smileDetector = new CascadeClassifier(FaceDetection.class.getResource("haarcascade_smile.xml").getPath().substring(1));
...
//                                }
                                ...
                                for (Rect rect2 : eyeDetections.toArray()) {
                                    ...
                                    Rect rectCrop = new Rect(rect2.x, rect2.y, rect2.width, rect2.height);  //crop the image to take the eye//
                                    ...
                                    if ((rect2.x > rect.x & rect2.x < (rect.x + rect.width)) && (rect2.y > rect.y & rect2.y < (rect.y + rect.height))) {                                     
                                        ...
                                        Mat circles = new Mat();
                                        Imgproc.HoughCircles(image_roi, circles, Imgproc.HOUGH_GRADIENT, 1, 10, 50,20 , 0, 0);
...
//                                        //Mat newframe=new Mat();
//                                        Mat circles = new Mat();
//                                        Imgproc.HoughCircles(frame, circles, Imgproc.HOUGH_GRADIENT, 1, 10, 30, 5, 5, 5);
//                                        System.out.println("circles found");
////                                        System.out.println("circle x= "+circles.get(0,0));
////                                        System.out.println("circle y= "+circles.get(1,0));
////                                        System.out.println("circle r= "+circles.get(2,0));
...
//                                            center.y = circle[1];
//                                            System.out.println("r= "+circle[2]);
//                                            Imgproc.circle(frame, center, (int) circle[2], new Scalar(255, 255, 100, 1), 4);
//                                        }
